    ...
    DateTimePicker.prototype = {
        ...
        init: function (element, options) {
            ...
            if (this.pickTime) {
                ...
                if (!this.upIcon) this.upIcon = 'fa fa-angle-up';
                if (!this.downIcon) this.downIcon = 'fa fa-angle-down';
              ...
              '<div class="bootstrap-datetimepicker-widget dropdown-menu" style="z-index:9999 !important;">' +
                '<ul class="list-unstyled">' +
                  '<li' + (collapse ? ' class="collapse in"' : '') + '>' +
                    ...
                    '</div>' +
                  '</li>' +
                  '<li class="picker-switch accordion-toggle"><a class="btn btn-xs btn-default"><span class="' + timeIcon + '"></span></a></li>' +
    ...
    TPGlobal.getTemplate = function (is12Hours, showSeconds, upIcon, downIcon) {
        ...
        '<div class="timepicker-picker">' +
          '<table class="table-condensed"' +
            ...
            '>' +
            '<tr>' +
              '<td><a href="#" class="btn btn-xs btn-default" data-action="incrementHours"><span class="' + upIcon + '"></span></a></td>' +
              '<td class="separator"></td>' +
              '<td><a href="#" class="btn btn-xs btn-default" data-action="incrementMinutes"><span class="' + upIcon + '"></span></a></td>' +
              (showSeconds ?
              '<td class="separator"></td>' +
              '<td><a href="#" class="btn btn-xs btn-default" data-action="incrementSeconds"><span class="' + upIcon + '"></span></a></td>' : '') +
            ...
            '<tr>' +
              ...
              '<td class="separator"></td>' +
              '<td>' +
              '<button type="button" class="btn btn-xs btn-default btn-primary" data-action="togglePeriod"></button>' +
              '</td>' : '') +
            '</tr>' +
            '<tr>' +
              '<td><a href="#" class="btn btn-xs btn-default" data-action="decrementHours"><span class="' + downIcon + '"></span></a></td>' +
              '<td class="separator"></td>' +
              '<td><a href="#" class="btn btn-xs btn-default" data-action="decrementMinutes"><span class="' + downIcon + '"></span></a></td>' +
              (showSeconds ?
              '<td class="separator"></td>' +
              '<td><a href="#" class="btn btn-xs btn-default" data-action="decrementSeconds"><span class="' + downIcon + '"></span></a></td>' : '') +
              (is12Hours ? '<td class="separator"></td>' : '') +
            '</tr>' +
          '</table>' +
        '</div>' +
